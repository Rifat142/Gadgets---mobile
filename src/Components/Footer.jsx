...
const Footer = () => {
  return (
    <div>
      <footer className="footer footer-center p-10 bg-blue-400 text-primary-content glass">
        <aside>
